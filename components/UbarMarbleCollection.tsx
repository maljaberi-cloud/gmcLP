...
const COLLECTIONS = [
  {
    ...
    sub: "Dark Beige",
    description:
      "Dark beige with soft natural veining. A classic choice for warm interiors.",
  ...
  },
  {
    ...
    sub: "Dark Pink",
    description:
      "Deep Pink stone offering bespoke luxury. Rare and geometrically complex.",
    finishes: ["Polished", "Honed", "Sandblasted", "Bush Hammered"],
    applications: [
      "Floors",
      "Walls",
  ...
  },
  {
    ...
    sub: "Light Beige",
    description:
      "Light Beige-Grey elegance. Minimalist tone for modern spaces.",
    finishes: ["Polished", "Honed", "Sandblasted", "Bush Hammered"],
...
const UbarMarbleCollection = () => {
  ...
  return (
    ...
    >
      {/* Background Typography - Static Opacity (Cheap to render) */}
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            {COLLECTIONS.map((stone, index) => (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {/* Static Render with Opacity Fade is cheaper than Layout Animation */}
                  <ArrowUpRight
                    className={`text-[#f1c83d] transition-opacity duration-300 ${activeStone === index ? "opacity-100" : "opacity-0"}`}
                  />
                </div>

                {/* Optimized Accordion: CSS-only transition for height */}
                <div
          ...
          <div className="lg:col-span-8 relative min-h-[600px]">
            {/* mode="wait" ensures old component unmounts before new one mounts to prevent layout jumping */}
            <AnimatePresence mode="wait">
              <motion.div
                key={COLLECTIONS[activeStone].id}
                // Simplified Animation: Less movement (x: 10 vs 20) and shorter duration
              ...
              >
                ...
                <div className="md:w-[45%] relative group overflow-hidden bg-gray-100">
                  ...
                  <img
                    ...
                    loading="eager" // Load immediately when switched
                  ...
                  <div className="absolute bottom-6 left-6 z-20">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-[#f1c83d] uppercase tracking-widest font-bold">
                        Raw Material
                      </span>
                    </div>
                ...
                <div className="md:w-[55%] relative bg-white p-8 lg:p-10 flex flex-col">
                  {/* Static Grid Background (Better for performance than complex CSS gradients) */}
                  <div
                  ...
                  <div className="relative z-10 flex justify-between items-start mb-8 border-b border-gray-100 pb-6">
                    <div>
                      ...
                      <h3 className="text-4xl lg:text-5xl font-serif text-gray-900">
                    ...
                    <div className="text-right hidden sm:block">
                      ...
                      <p className="text-sm font-mono font-bold text-[#6a6931]">
                        {COLLECTIONS[activeStone].code}
                      </p>
                    </div>
                  </div>

                  {/* Description */}
                  <p className="relative z-10 text-gray-500 leading-relaxed font-light text-md mb-8 pr-4">
                    {COLLECTIONS[activeStone].description}
                  </p>

                  {/* Tech Grid - Grouped Animations for Performance */}
                  <div className="relative z-10 grid grid-cols-2 gap-y-8 gap-x-4 mb-10">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-xl text-[#6a6931]">
                        {COLLECTIONS[activeStone].Thickness}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 leading-6">
                        {COLLECTIONS[activeStone].applications
                          .slice(0, 3)
                          .join(", ")}
                        <br />
                        <span className="italic text-[#f1c83d]">
                          + {COLLECTIONS[activeStone].applications.length - 3}{" "}
                          more
                        </span>
                      </p>
                    </div>
